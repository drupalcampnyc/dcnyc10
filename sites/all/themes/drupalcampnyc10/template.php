...
function drupalcampnyc10_preprocess_page(&$vars, $hook) {
  ...
  $headscript = '<script type="text/javascript">fbg.hideFOUT("onload");</script>';
  ...
  $vars['ie8_styles'] .= "  <link type=\"text/css\" rel=\"stylesheet\" media=\"all\" href=\"".base_path().path_to_theme()."/css/desktop-tablet-fluid.css\" />\r" . $vars['ie8_styles_append'];
  $vars['ie7_styles'] .= "  <link type=\"text/css\" rel=\"stylesheet\" media=\"all\" href=\"".base_path().path_to_theme()."/css/desktop-tablet-fluid.css\" />\r" . $vars['ie7_styles_append'];
  $vars['ie6_styles'] .= "  <link type=\"text/css\" rel=\"stylesheet\" media=\"all\" href=\"".base_path().path_to_theme()."/css/desktop-tablet-fluid.css\" />\r" . $vars['ie6_styles_append'];
  */
